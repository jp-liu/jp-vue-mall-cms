<template>
  <div class="overview">
    ...
    <jp-card title="技术栈">
      <jp-text-link :text-arrs="technologyStacks" />
      <jp-descriptions title="生产环境依赖" :column="2" :table-datas="dependencies" />
      <jp-descriptions title="开发环境依赖" :column="2" :table-datas="devDependencies" />
    </jp-card>
    <jp-card title="项目结构">
      <div class="c-left">
        <jp-code language="bash" :code="projectDir" />
      </div>
    </jp-card>
    <jp-card title="项目规范">
      <jp-descriptions
...
import JpDescriptions from '@/base-ui/descriptions'
import JpTextLink from '@/base-ui/text-link'
import JpCode from '@/base-ui/code'
import JpCard from '@/base-ui/card'
